...
class Order(models.Model):
    ...
    headquarter = models.ForeignKey(Headquarter,related_name='orders', on_delete=models.CASCADE)
...
class OrderDetail(models.Model):
    ...
    order = models.OneToOneField(Order,related_name='order_detail', on_delete=models.CASCADE)
